...
public class AdapterRecyclerFirstItem extends RecyclerView.Adapter<AdapterRecyclerFirstItem.MyViewHolder> {

    List<FirstItem> firstItems;
    Context context;

    public AdapterRecyclerFirstItem(Context context, List<FirstItem> firstItems) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_first_recycler, parent, false);
